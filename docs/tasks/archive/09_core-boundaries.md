...
**Status:** ACCEPTED(2026-09-09,使用者:「09 可以歸檔」)
...
- 無。使用者 2026-09-09 驗收「09 可以歸檔」,本檔歸檔(V01.0R.004)。核心側登記在案的債全部處理完;
  剩下的延後事項(D-003、D-005…D-007、D-009)各有觸發條件,寫在 `docs/DEFERRALS.md`。
