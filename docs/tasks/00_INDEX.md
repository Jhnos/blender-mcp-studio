...
- **目前在做（2026-09-12）:** 16 雙探頭量測工作站。使用者要求收斂並減少五金，已明確開始簡化版：兩支獨立雙節臂，取消末端四連桿／長穿軸／金屬軸套，螢幕支承併入上蓋。新模型 `tmp/lab-station-simple/simple-concept.blend`；解析／局部真機與三姿態檢查通過，V01.0R.01I 最終完整 CI 全綠。下一步齒槽、埋入螺母與夾頭保持；ACTIVE，非可印定稿。舊 rotary 僅保留回歸，不再擴充。
