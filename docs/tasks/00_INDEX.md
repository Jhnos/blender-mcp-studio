...
- **目前在做（2026-09-12）:** 16 雙探頭量測工作站。使用者接受商用電極臂參考方向並要求延伸；simple 為基線，前臂改平行雙桿＋三角平台，上臂鉸鍊參與定位、探頭角度另手調。`tmp/lab-station-electrode/electrode-concept.blend`；46 單頭位置、16 折屏角度及斷接負對照通過，V01.0R.01J 完整 CI 全綠。ACTIVE，非可印／承重定稿；被動軸防脫與鎖定仍待完成。
