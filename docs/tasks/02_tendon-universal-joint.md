...
[PR #4](https://github.com/Jhnos/blender-mcp-studio/pull/4) is merged (`901cb53`, 2026-09-05); the controlled package is on `main`.
Download it and import one coupon at 100% millimetres into the slicer.
