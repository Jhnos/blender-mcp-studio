...
FROZEN_EXPLICIT_GUARDS = frozenset(
    {
        ("scene.py", "_run_undo_redo", 503),
        ("scene.py", "analyze_image", 413),
        ("scene.py", "analyze_image", 422),
        ("scene.py", "analyze_image", 500),
        ("scene.py", "analyze_image", 503),
        ("scene.py", "apply_material", 400),
        ("scene.py", "apply_material", 404),
        ("scene.py", "apply_material", 500),
        ("scene.py", "apply_material", 503),
        ("scene.py", "create_snapshot", 500),
        ("scene.py", "create_snapshot", 503),
        ("scene.py", "delete_snapshot", 404),
        ("scene.py", "delete_snapshot", 503),
        ("scene.py", "generate_3d", 500),
        ("scene.py", "generate_3d", 503),
        ("scene.py", "refine_model", 500),
        ("scene.py", "refine_model", 503),
        ("scene.py", "restore_snapshot", 404),
        ("scene.py", "restore_snapshot", 410),
        ("scene.py", "restore_snapshot", 500),
        ("scene.py", "restore_snapshot", 503),
        ("scene.py", "run_pipeline", 404),
        ("scene.py", "run_pipeline", 500),
        ("scene.py", "search_materials", 503),
        ("scene.py", "select_object", 500),
        ("scene.py", "update_object", 500),
    }
)
