...
async def test_search_returns_empty_on_http_error(adapter, respx_mock):
    ...
    respx_mock.get("https://api.polyhaven.com/assets").mock(return_value=httpx.Response(503))
...
def api_client_with_polyhaven():
    ...
    mock_ph.get_download_url = AsyncMock(
        return_value=PolyHavenFile(
